...
public class ChooseRewardPresenterTest {

    private static final int REWARD_ID = 2899991;
    ...
    private ChooseRewardPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);

        presenter = spy(new ChooseRewardPresenter(interactor, eventDispatcher, scheduler));
    ...
    public void should_confirm_reward_voucher_selection() throws Exception {
        ...
        presenter.onConfirmRewardChoice(rewardSelection);
