...
public class SecurityPreferencesActivityTest extends BaseAndroidTest {

    @Rule
    public ActivityTestRule<SecurityPreferencesActivity> activityTestRule =
            new ActivityTestRule<>(SecurityPreferencesActivity.class, false, false);
    ...
    @Test
    public void should_show_security_preferences() throws Exception {
        setUpNetworkModuleAndLaunchActivity(BuildConfig.TEST_BASE_URL);

        onView(withText(R.string.user_prefs_security_group_header_message_78))
