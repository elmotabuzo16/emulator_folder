...
public class PrivacyPreferencesActivityTest extends BaseAndroidTest {

    @Rule
    public ActivityTestRule<PrivacyPreferencesActivity> activityTestRule =
            new ActivityTestRule<>(PrivacyPreferencesActivity.class, false, false);
    ...
    @Test
    public void should_show_privacy_preferences() throws Exception {
        setUpNetworkModuleAndLaunchActivity(BuildConfig.TEST_BASE_URL);

        onView(withText(R.string.user_prefs_privacy_group_header_message_71))
