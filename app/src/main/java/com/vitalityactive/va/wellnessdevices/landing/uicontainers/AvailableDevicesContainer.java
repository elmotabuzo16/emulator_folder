...
public class AvailableDevicesContainer extends GenericTitledListContainerWithAdapter.TitledListWithAdapter {
    private GenericRecyclerViewAdapter<PartnerDto, AvailableDeviceViewHolder> adapter;

    public AvailableDevicesContainer(Context context,
                                     GenericRecyclerViewAdapter.OnItemClickListener<PartnerDto> clickListener) {
        super(context.getString(R.string.WDA_landing_available_link_section_title_426));
    ...
    private static GenericRecyclerViewAdapter<PartnerDto, AvailableDeviceViewHolder> getContentAdapter(Context context,
        ...
        return new GenericRecyclerViewAdapter<>(context,
                ...
                R.layout.view_wd_available_device_list_item,
                new AvailableDeviceViewHolder.Factory(),
                clickedListener);
    }
}
