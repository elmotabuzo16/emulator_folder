...
public class VHRPrivacyPolicyPresenterImpl extends TermsAndConditionsPresenterImpl<VHRPrivacyPolicyUserInterface> implements VHRPrivacyPolicyPresenter {
    ...
    public VHRPrivacyPolicyPresenterImpl(Scheduler scheduler,
