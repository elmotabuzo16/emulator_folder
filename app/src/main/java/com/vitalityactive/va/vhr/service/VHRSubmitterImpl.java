package com.vitalityactive.va.vhr.service;
...
public class VHRSubmitterImpl extends BaseQuestionnaireSubmitter {
    private final VitalityAgeRepository vitalityAgeRepository;

    public VHRSubmitterImpl(QuestionnaireStateManager questionnaireStateManager,
