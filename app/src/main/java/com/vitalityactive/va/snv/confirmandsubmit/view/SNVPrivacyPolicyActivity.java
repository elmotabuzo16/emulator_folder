...
public class SNVPrivacyPolicyActivity extends TermsAndConditionsBaseActivity<SNVPrivacyPolicyUserInterface, SNVPrivacyPolicyPresenter> implements SNVPrivacyPolicyUserInterface {
    ...
    SNVPrivacyPolicyPresenter termsAndConditionsPresenter;
    ...
    @Override
    protected SNVPrivacyPolicyUserInterface getUserInterface() {
        return this;
    }

    @Override
    public void navigateAfterTermsAndConditionsAccepted() {
        navigationCoordinator.navigateAfterSNVPrivacyPolicyAccepted(this);
    }
    ...
    @Override
    protected SNVPrivacyPolicyPresenter getPresenter() {
