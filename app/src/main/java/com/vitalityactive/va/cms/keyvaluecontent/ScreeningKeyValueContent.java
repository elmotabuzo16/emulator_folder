...
public class ScreeningKeyValueContent implements ScreeningDeclarationContent {
    @NonNull
    ...
    @NonNull
    @SerializedName("learnMoreSection1LinkContent")
    private String learnMoreSection1LinkContent = "";
    @NonNull
    ...
    public String getLearnMoreSection1LinkContent() {
        return learnMoreSection1LinkContent;
    }
