...
class HealthAttributeGroupDetailViewHolder extends GenericRecyclerViewAdapter.ViewHolder<HealthAttributeDTO> {
    ...
    private final VHCHealthAttributeContent vhcHealthAttributeContent;
    ...
    private void setUpTextViews(HealthAttributeDTO dataItem) {
        ...
        if (unitOfMeasure != UnitsOfMeasure.UNKNOWN) {
            setTextOfView(groupMeasurementUnitText, vhcHealthAttributeContent.getUnitOfMeasureSymbol(unitOfMeasure));
        }
    ...
    private void setupGroupTitle(HealthAttributeDTO dataItem) {
        String fieldName = vhcHealthAttributeContent.getFieldName(dataItem.getEventTypeKey());
    ...
    private void displaySubtitleIfAvailable(HealthAttributeDTO dataItem) {
        String validOptionDescription = vhcHealthAttributeContent.getValidOptionDescription(dataItem.getValue());
    ...
    private void displayPointsStatusSubtextIfAvailable(HealthAttributeDTO dataItem) {
        if (dataItem.getPointsStatus().isEmpty() || dataItem.getPotentialPoints() <= 0) {
            return;
        }
    ...
    private void displayFeedbackIfAvailable(HealthAttributeDTO dataItem) {
        ...
        if (feedbackTypeKey == null || dataItem.getPotentialPoints() <= 0)
            return;
        ...
        final String inHealthyRangeStringFromEventType =
                healthAttributeFeedbackType.inHealthyRange()
                        ? vhcHealthAttributeContent.getInHealthyRangeText()
                        : vhcHealthAttributeContent.getOutOfHealthyRangeText();
    ...
    public static class Factory
        ...
        public Factory(VHCHealthAttributeContent vhcHealthAttributeContent,
                       Date currentMembershipPeriodStart,
                       Date currentMembershipPeriodEnd,
                       String groupDescription) {
            this.vhcHealthAttributeContent = vhcHealthAttributeContent;
