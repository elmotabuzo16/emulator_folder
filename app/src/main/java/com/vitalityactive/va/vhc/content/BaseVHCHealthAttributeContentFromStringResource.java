...
public class BaseVHCHealthAttributeContentFromStringResource extends UnitOfMeasureStringLoader implements VHCHealthAttributeContent {
    ...
    public BaseVHCHealthAttributeContentFromStringResource(Context vitalityActiveApplication,
