...
public class VHCProofItemDetailActivity extends BaseActivity implements EventListener<AlertDialogFragment.DismissedEvent> {
    ...
    @Inject
    VHCAddProofInteractor interactor;
    @Inject
