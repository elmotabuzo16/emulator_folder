...
public class MWBPrivacyPolicyActivity extends TermsAndConditionsBaseActivity<MWBPrivacyPolicyUserInterface, TermsAndConditionsPresenter<MWBPrivacyPolicyUserInterface>>
        implements MWBPrivacyPolicyUserInterface {
    ...
    MWBPrivacyPolicyPresenter mwbPrivacyPolicyPresenter;
    ...
    protected void create(Bundle savedInstanceState) {
        ...
        mwbPrivacyPolicyPresenter.setQuestionnaireTypeKey(questionnaireTypeKey);
    }
    ...
    @Override
    protected MWBPrivacyPolicyUserInterface getUserInterface() {
        return this;
    }
    ...
    @Override
    protected TermsAndConditionsPresenter<MWBPrivacyPolicyUserInterface> getPresenter() {
        return mwbPrivacyPolicyPresenter;
    }
    ...
    public void onEvent(AlertDialogFragment.DismissedEvent event) {
        ...
        if (wasTryAgainButtonTapped(event)) {
            mwbPrivacyPolicyPresenter.onUserTriesToSubmitAgain();
        }
    }
