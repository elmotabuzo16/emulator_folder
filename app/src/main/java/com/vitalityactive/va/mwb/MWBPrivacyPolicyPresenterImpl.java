...
public class MWBPrivacyPolicyPresenterImpl extends TermsAndConditionsPresenterImpl<MWBPrivacyPolicyUserInterface> implements MWBPrivacyPolicyPresenter {
    ...
    public MWBPrivacyPolicyPresenterImpl(Scheduler scheduler,
