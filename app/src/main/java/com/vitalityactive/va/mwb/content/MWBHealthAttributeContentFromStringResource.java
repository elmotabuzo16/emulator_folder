...
public class MWBHealthAttributeContentFromStringResource extends UnitOfMeasureStringLoader implements MWBHealthAttributeContent {

    private InsurerConfigurationRepository insurerConfigurationRepository;

    public MWBHealthAttributeContentFromStringResource(Context vitalityActiveApplication, InsurerConfigurationRepository insurerConfigurationRepository){
    ...
    public String getOnboardingTitle() {
        return getString(R.string.home_card_card_section_title_mwb_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection1Title() {
        return getString(R.string.MWB_onboarding_section_1_title_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection1Content() {
        return getString(R.string.MWB_onboarding_section_1_message_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection2Title() {
        return getString(R.string.MWB_onboarding_section_2_title_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection2Content() {
        return getString(R.string.MWB_onboarding_section_2_message_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection3Title() {
        return getString(R.string.MWB_onboarding_section_3_title_9999);
    }

    @NonNull
    @Override
    public String getOnboardingSection3Content() {
        return getString(R.string.MWB_onboarding_section_3_message_9999);
    }
    ...
    public String getLandingTitle() {
        return getString(R.string.landing_screen_health_measurements_title_132);
    }

    @Override
    public String getLandingSubtitle() {
        return getString(R.string.landing_screen_health_measurement_message_133);
    }
    ...
    @Override
    public String getOtherBloodLipidsGroupTitle() {
        return getString(R.string.measurement_other_blood_lipids_title_848);
    }
    ...
    @NonNull
    @Override
    public String getFootInchString() {
        return getString(R.string.foot_inch_summary_9999);
    }

    @NonNull
    @Override
    public String getStonePoundString() {
        return getString(R.string.stone_pound_summary_9999);
    }

    @NonNull
    @Override
    public String getValidationRequiredForPointsString() {
        return getString((R.string.error_required_for_points_1170));
    }
