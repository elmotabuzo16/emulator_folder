...
public class BaseMWBHealthAttributeContentFromStringResource extends UnitOfMeasureStringLoader implements MWBHealthAttributeContent {
    private InsurerConfigurationRepository insurerConfigurationRepository;

    public BaseMWBHealthAttributeContentFromStringResource(Context vitalityActiveApplication, InsurerConfigurationRepository insurerConfigurationRepository){
    ...
    public String getOnboardingTitle() {
        return getString(R.string.home_card_card_title_125);
    }

    @NonNull
    @Override
    public String getOnboardingSection1Title() {
        return getString(R.string.onboarding_section_1_title_126);
    }

    @NonNull
    @Override
    public String getOnboardingSection1Content() {
        return getString(R.string.onboarding_section_1_message_127);
    }

    @NonNull
    @Override
    public String getOnboardingSection2Title() {
        return getString(R.string.onboarding_section_2_title_128);
    }

    @NonNull
    @Override
    public String getOnboardingSection2Content() {
        return getString(R.string.onboarding_section_2_message_129);
    }

    @NonNull
    @Override
    public String getOnboardingSection3Title() {
        return getString(R.string.onboarding_section_3_title_130);
    }

    @NonNull
    @Override
    public String getOnboardingSection3Content() {
        return getString(R.string.onboarding_section_3_message_341);
    }
