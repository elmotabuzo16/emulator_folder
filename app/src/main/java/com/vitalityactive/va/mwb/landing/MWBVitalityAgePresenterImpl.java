...
public class MWBVitalityAgePresenterImpl implements MWBVitalityAgePresenter{
    ...
    public MWBVitalityAgePresenterImpl(EventDispatcher eventDispatcher, HealthAttributeInformationServiceClient attributeInformationServiceClient, VitalityAgeInteractor vitalityAgeInteractor, DeviceSpecificPreferences deviceSpecificPreferences) {
