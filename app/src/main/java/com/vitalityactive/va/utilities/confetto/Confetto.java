...
public class Confetto {
    ...
    // Visible for testing
    static Long computeMillisToReachTarget(Float targetVelocity, float initialVelocity,
                                           float acceleration) {
    ...
    // Visible for testing
    static long computeBound(float initialPos, float velocity, float acceleration,
    ...
    private void drawInternal(Canvas canvas, Matrix matrix, Paint paint, float x, float y,
                              float rotation) {
