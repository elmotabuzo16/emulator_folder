...
public class EventsFeedContentImpl implements EventsFeedContent {
    private Context context;

    public EventsFeedContentImpl(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public String getEventsFeedEntryCategoryTitle(int categoryTypeKey) {
