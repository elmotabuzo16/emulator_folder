...
//                        desc += presenter.getEmail();
    ...
    public void bindWithMarketSpecific() {
        ...
        if(presenter.hasSettingsButton()){
            if(presenter instanceof ShareVitalityStatusPresenter) {
                manageInSettingsButton.setText(R.string.uke_communication_pref_button_status_377);
                manageInSettingsButton.setOnClickListener(((ShareVitalityStatusPresenter) presenter).getClickListener());
            }
        }
    }
