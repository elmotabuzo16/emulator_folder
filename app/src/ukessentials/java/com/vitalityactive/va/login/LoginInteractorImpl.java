...
public class LoginInteractorImpl extends BaseLoginInteractorImpl {
    ...
    @Inject
    LoginInteractorImpl(@NonNull LoginServiceClient loginServiceClient, @NonNull EventDispatcher eventDispatcher, LoginRepository loginRepository, DeviceSpecificPreferences preferences, UKEURLSwitcher baseURLSwitcher, VitalityAgePreferencesManager vitalityAgePreferencesManager,
