...
public class InsurerConfigurationRepository {
    ...
    private boolean hasProductFeature(int productFeatureTypeKey) {
        return dataStore.hasModelInstance(ProductFeature.class, "type", productFeatureTypeKey);
    }
    ...
    private boolean hasFeatureType(int featureType) {
        return dataStore.hasModelInstance(ProductFeature.class, "featureType", featureType);
    }
    ...
    public List<Integer> getConfiguredVHCFeatureTypes() {
        return dataStore.getModels(ProductFeature.class,
    ...
    @NonNull
    private DataStore.QueryExecutor<ProductFeature, RealmQuery<ProductFeature>> getQueryToSelectAllProductFeaturesForVHCFeatureTypes() {
        return new DataStore.QueryExecutor<ProductFeature, RealmQuery<ProductFeature>>() {
            @Override
    ...
    private Integer[] getAllVHCEventProductFeatureTypes() {
        return new Integer[]{
                ...
                ProductFeatureType._OTHERBLOODLIPID
        };
    }

    @NonNull
    private DataStore.ModelListMapper<ProductFeature, Integer> getModelMapperForProductFeaturesToUniqueListOfVHCFeatureTypes() {
        return new DataStore.ModelListMapper<ProductFeature, Integer>() {
            @Override
            public List<Integer> mapModels(List<ProductFeature> models) {
                ArrayList<Integer> featureTypeKeys = new ArrayList<>();
                for (ProductFeature productFeature : models) {
